...
if($flag == 0){
    ...
    $result = mysqli_query($conn,$sql);
   echo "<img src='img/success.png' alt='success'  class='mx-auto d-block my-5' height='300px' width='300px'>";
    echo "<h1 class='text-center my-2'>Thank you for subscribing</h1>";
}
else{
    echo "<img src='img/fail.png' alt='fail'  class='mx-auto d-block my-5' height='300px' width='300px'>";
    echo "<h1 class='text-center my-2'>This email is already registered</h1>";
}
