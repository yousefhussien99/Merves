<?php 
 ...
 $sql = "INSERT INTO products (name,price,src,descrption) VALUES ('".$_POST['name']."','".$_POST['price']."','".$_POST['image']."','".$_POST['description']."')";
...
<script>
    ...
    function sendEmails() {
        if (email.length === 0) {
            window.location.href = "addproduct.html"; // Redirect when all emails are sent
            return;
        }
        ...
        var templateParams = {
            ...
            replyto: "hh",
            message: "please check the new product in the website",
        };
